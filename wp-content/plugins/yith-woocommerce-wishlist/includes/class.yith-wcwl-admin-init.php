...
of YITH WOOCOMMERCE WISHLIST to benefit from all features!', 'yith-woocommerce-wishlist' ),
			...
			$general_settings_end = array(
				'add_to_wishlist_position' => array(
					...
					'desc'     => __( 'You can add the button in variable products only after the "Thêm vào gi?" button or using the shortcode [yith_wcwl_add_to_wishlist].', 'yith-woocommerce-wishlist' ),
					'id'       => 'yith_wcwl_button_position',
					'type'     => 'select',
					'class'    => 'chosen_select',
					'css'      => 'min-width:300px;',
					'options'  => array(
						'add-to-cart' => __( 'After "Thêm vào gi?"', 'yith-woocommerce-wishlist' ),
				...
				'redirect_to_cart' => array(
					...
					'desc'    => __( 'Redirect to cart page if "Thêm vào gi?" button is clicked in the wishlist page.', 'yith-woocommerce-wishlist' ),
				...
				'add_to_cart_text' => array(
					'name'    => __( '"Thêm vào gi?" text', 'yith-woocommerce-wishlist' ),
					'id'      => 'yith_wcwl_add_to_cart_text',
					'std'     => __( 'Thêm vào gi?', 'yith-woocommerce-wishlist' ), // for woocommerce < 2.0
					'default' => __( 'Thêm vào gi?', 'yith-woocommerce-wishlist' ), // for woocommerce >= 2.0
					'type'    => 'text',
					'css'     => 'min-width:300px;',
				),
				...
				'show_add_to_cart' => array(
					'name'    => __( 'Show "Thêm vào gi?" button', 'yith-woocommerce-wishlist' ),
					'desc'    => __( 'Show "Thêm vào gi?" button for each product in wishlist', 'yith-woocommerce-wishlist' ),
			...
			$options['styles'] = array(
				...
				'add_to_cart_icon' => array(
					'name'     => __( '"Thêm vào gi?" icon', 'yith-woocommerce-wishlist' ),
					'desc'     => __( 'Add an icon to the "Thêm vào gi?" button', 'yith-woocommerce-wishlist' ),
		...
		private function _styles_options() {
			...
			<div class="color-panel">
				...
				<h4><?php _e( '"Thêm vào gi?" button', 'yith-woocommerce-wishlist' ) ?></h4>
				<?php
